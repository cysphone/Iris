<?php include 'includes/header.php'; ?>
    ...
    <section data-anim-wrap class="pageHero -type-2">
      <div data-anim-child="img-right cover-white delay-1" class="pageHero__bg">
        <img src="img/rooms/Premier/2.jpg" alt="image">
      </div>
          ...
          <div class="col-lg-10 col-md-11">
            <div class="ss-scale-2 js-section-slider" data-gap="100" data-slider-cols="xl-1 lg-1 md-1 sm-1 base-1" data-loop data-nav-prev="js-slider1-prev" data-nav-next="js-slider1-next" data-pagination="js-slider1-pagination">
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <div class="ratio ratio-16:9">
                    <img src="img/rooms/Premier/4.jpg" alt="image" class="img-ratio">
                  </div>
                </div>

                <div class="swiper-slide">
                  <div class="ratio ratio-16:9">
                    <img src="img/rooms/Premier/7.png" alt="image" class="img-ratio">
                  </div>
                </div>
                ...
                <div class="swiper-slide">
                  <div class="ratio ratio-16:9">
                    <img src="img/rooms/Premier/8.jpg" alt="image" class="img-ratio">
                  </div>
                </div>

                <div class="swiper-slide">
                  <div class="ratio ratio-16:9">
                    <img src="img/rooms/Premier/22.jpg" alt="image" class="img-ratio">
                  </div>
                </div>

                <div class="swiper-slide">
                  <div class="ratio ratio-16:9">
                    <img src="img/rooms/Premier/23.jpg" alt="image" class="img-ratio">
                  </div>
                </div>
