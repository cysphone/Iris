...
<!-- Mirrored from creativelayers.net/themes/swiss-resort-html/cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 21 Jul 2025 16:03:12 GMT -->
<head>
  <!-- Required meta tags -->
  <meta charset="UTF-8">
        ...
        <div class="row y-gap-40 justify-between">
                ...
                <tr>
                  <td>
                    <div class="d-flex items-center">
                      ...
                      <div class="ml-30">
                        <h2 class="text-24 fw-500">Luxury Villa Suite</h2>
                        <div class="text-15 mt-15"><span class="fw-500">Date:</span> 2023-11-08 - 2023-11-09</div>
                        <div class="text-15 mt-5"><span class="fw-500">Details:</span> Rooms: 1, Adults: 1,</div>
                      </div>
                    </div>
                  </td>
          ...
          <div class="col-xl-4 col-lg-5">
            <div class="sidebar px-40 py-40 bg-light-1">
              ...
              <button class="button -md bg-accent-1 -accent-2 text-white w-1/1 mt-30">Proceed to checkout</button>
            </div>
          </div>
        </div>
      </div>
...
<!-- Mirrored from creativelayers.net/themes/swiss-resort-html/cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 21 Jul 2025 16:03:13 GMT -->
</html>