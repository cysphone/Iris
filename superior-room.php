<?php include 'includes/header.php'; ?>
    <section data-anim-wrap class="pageHero -type-2">
      <div data-anim-child="img-right cover-white delay-1" class="pageHero__bg">
        <img src="img/rooms/Superior/4.png" alt="image">
      </div>
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <div class="ratio ratio-16:9">
                    <img src="img/rooms/Superior/2.png" alt="image" class="img-ratio">
                  </div>
                </div>
                
                <div class="swiper-slide">
                  <div class="ratio ratio-16:9">
                    <img src="img/rooms/Superior/3.png" alt="image" class="img-ratio">
                  </div>
                </div>

                <div class="swiper-slide">
                  <div class="ratio ratio-16:9">
                    <img src="img/rooms/Superior/5.png" alt="image" class="img-ratio">
                  </div>
                </div>
                ...
                <div class="swiper-slide">
                  <div class="ratio ratio-16:9">
                    <img src="img/rooms/Superior/8.png" alt="image" class="img-ratio">
                  </div>
                </div>

                <div class="swiper-slide">
                  <div class="ratio ratio-16:9">
                    <img src="img/rooms/Superior/7.png" alt="image" class="img-ratio">
                  </div>
                </div>
                ...
                <div data-anim-child="slide-up delay-4">
                  <a href="business-class-room.php" class="roomCard -type-2 -hover-button-center">
                    <div class="roomCard__image -no-rounded ratio ratio-45:54 -hover-button-center__wrap">
                      ...
                      <div class="roomCard__price round-0 text-15 fw-500 bg-white text-accent-1">₹5,000 / NIGHT</div>
                    ...
                    <div class="roomCard__content mt-30">
                      <div class="d-flex justify-between items-end">
                        <h3 class="roomCard__title lh-065 text-40 md:text-24">Business Class Rooms</h3>
                      </div>
